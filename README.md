# dan-lab-to-nwb
NWB conversion scripts for Dan lab data to the
...
https://github.com/catalystneuro/dan-lab-to-nwb//tree/main/src/huang_2025/convert_session.py
...
```
pip install --editable .[huang_2025]
```

You can run a specific conversion with the following command:
```
python src/dan_lab_to_nwb/huang_2025/convert_session.py
```
...
For example, for the conversion `huang_2025` you can find a directory located in `src/dan-lab-to-nwb/huang_2025`. 
